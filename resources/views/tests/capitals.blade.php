...
<div class="flagsContent" style="text-align:center;margin-top:20px;">
    <button id="previousCapital" style="display:none"><</button>
    <p id="capitalLabel"></p>
<button id="nextCapital" style="display:none">></button>
<br>
...
<form action='/capitals/update' type='submit' method='POST' id="capitalForm">
@csrf
<input type='text' name='countryName' id="capitalInput" style="display:none">
...
<script>
  ...
  capitalInput.addEventListener("keyup", (event) => {
    var countryIso = document.getElementById("countryPic").getAttribute("alt");
    if(countryIso == countries[countryIndex].code.toLowerCase() && document.getElementById("capitalInput").value == countries[countryIndex].name){
      flagsGuessed++;
  ...
  startButton.addEventListener("click", (event) => {
    ...
    var countryLabel = document.getElementById("capitalLabel");
    countryLabel.innerText = "What is the capital of "+countries[countryIndex].name+"?";

    document.getElementById("counter").setAttribute("style", "");
    document.getElementById("capitalInput").setAttribute("style", "");
    document.getElementById("previousCapital").setAttribute("style", "");
    document.getElementById("nextCapital").setAttribute("style", "");
